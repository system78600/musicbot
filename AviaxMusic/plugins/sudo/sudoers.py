...
async def sudoers_list(client, message: Message):
    ...
    #await message.reply_photo(photo="https://graph.org/file/27f935fc5a7c971219a5b.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
    await message.reply_photo(photo="https://graph.org/file/27f935fc5a7c971219a5b.jpg", caption="**» ᴄʜᴇᴄᴋ sᴜᴅᴏ ʟɪsᴛ ʙʏ ɢɪᴠᴇɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ.**\n\n**» ɴᴏᴛᴇ:**  ᴏɴʟʏ sᴜᴅᴏ ᴜsᴇʀs ᴄᴀɴ ᴠɪᴇᴡ. ", reply_markup=reply_markups)
...
async def check_sudo_list(client, callback_query: CallbackQuery):
    ...
    if callback_query.from_user.id not in SUDOERS:
        return await callback_query.answer("𝐤𝐲𝐚 𝐫𝐞 𝐦𝐚𝐝𝐚𝐫𝐜𝐡𝐨𝐝 𝐬𝐮𝐝𝐨 𝐝𝐞𝐤𝐡𝐧𝐚 𝐡𝐚𝐢 𝐭𝐮𝐣𝐡𝐞🖕😂", show_alert=True)
    else:
